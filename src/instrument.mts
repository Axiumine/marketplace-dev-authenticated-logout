 ...
 *
 * ⚠️ **Nothing here configures TLS, and nothing here may.** This file once handed `Sentry.init`
 ...
 * arrival of a new one in a future release is caught by the version guard in `test/sentryVersionGuard.test.mts`.
 *
